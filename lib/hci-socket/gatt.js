...
const Gatt = function (address, aclStream) {
  ...
  this._services = servicesCache[address] || {};
  this._characteristics = characteristicsCache || {};
  this._descriptors = {};
...
Gatt.prototype.addService = function (service) {
  ...
  servicesCache[this._address] = this._services;
};
...
Gatt.prototype.addCharacteristics = function (serviceUuid, characteristics) {
  ...
  characteristicsCache[this._address] = this._characteristics;
};
